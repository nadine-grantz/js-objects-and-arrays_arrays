...
console.log("Aufgabe 1: ", exampleArray);

// EXERCISE 2
// Nest an array inside array nestedArray. After that nestedArray should contain an array as an element.

const nestedArray = ["example", ["Hallo", 20], 10, true];
console.log("Aufgabe 2: ", nestedArray);
...
console.log("Aufgabe 3: ", firstNumber);
...
console.log("Aufgabe 5: ", nestedNumber);
...
console.log("Aufgabe 6: ", petsWithPush);
...
fruitsWithPop.pop();
console.log("Aufgabe 7: ", fruitsWithPop);
...
console.log("Aufagbe 8: ", unshiftedPets);
...
shiftedFruits.shift();
console.log("Aufagbe 9: ", shiftedFruits);
